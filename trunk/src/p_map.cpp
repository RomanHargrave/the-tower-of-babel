...
*/
	...
	if (!ld->backsector)
	{ // One sided line
		if (tm.thing->flags2 & MF2_BLASTED && !(tm.thing->flags6 & MF6_NOBLASTDAMAGE))
		{
...
//				abs(thing->y - tmy) <= thing->radius)
	...
	if ((tm.thing->flags2 & MF2_BLASTED  && !(tm.thing->flags6 & MF6_NOBLASTDAMAGE)) && (thing->flags & MF_SHOOTABLE))
	{
